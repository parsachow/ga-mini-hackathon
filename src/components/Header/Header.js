  ...
  return (    
    <header>  
      ...
      <nav className="navbar"> 
        ...
        <span>
        <Link to="/settings"><svg xmlns="http://www.w3.org/2000/svg" className='user-icon'aria-labelledby="title-profile" viewBox="0 0 24 24"> <g> <path fill="none" d="M0 0h24v24H0z"/> <title id='title-profile'>Profile Settings</title> <path d="M20 22H4v-2a5 5 0 0 1 5-5h6a5 5 0 0 1 5 5v2zm-8-9a6 6 0 1 1 0-12 6 6 0 0 1 0 12z"/> </g> </svg></Link>
