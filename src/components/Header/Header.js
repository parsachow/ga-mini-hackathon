        ...
        <div>
          ...
          <span>
            ...
            {jwt && <Link to="" onClick={logout}><svg className='logout-profile' aria-labelledby="title-logout" viewBox="0 0 37 37" fill="none" xmlns="http://www.w3.org/2000/svg"><title id='title-logout'>Logout</title>
              <path d="M18.4999 18.4989C23.2437 18.4989 27.0892 14.6533 27.0892 9.9096C27.0892 5.16587 23.2437 1.32031 18.4999 1.32031C13.7562 1.32031 9.91064 5.16587 9.91064 9.9096C9.91064 14.6533 13.7562 18.4989 18.4999 18.4989Z" stroke="#000001" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M34.8327 35.68C33.7232 32.2202 31.5436 29.202 28.6082 27.0607C25.6728 24.9194 22.1333 23.7656 18.4998 23.7656C14.8664 23.7656 11.3269 24.9194 8.39149 27.0607C5.4561 29.202 3.27652 32.2202 2.16699 35.68H34.8327Z" stroke="#000001" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg></Link>}
          </span>
        </div>
        <div className="title">
